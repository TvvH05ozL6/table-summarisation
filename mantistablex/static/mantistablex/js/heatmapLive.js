...
(function (a, b, c) {
  ...
  var c = function i() {
    ...
    function d(b) {
      ...
      /**
       * *******************************************************
       * change height of canvas with height of the page
       * *******************************************************
      */
      this._height = $('.main-header').height() + $('#tracking').height();
      /**
       * *******************************************************
       * *******************************************************
      */
...
/////////////////////////////////////
var _GuiHeatMapHtml = '<style>  #heatmapContainerWrapper { width:100%; position:absolute; left:0%; top:0%;  z-index:8;  pointer-events: none; } #heatmapContainer { height: 100%; width:100%; position:absolute; left:0%; top:0%;pointer-events: none; z-index:8;} </style> <div id="heatmapContainerWrapper"> <div id="heatmapContainer"> </div>   </div>';
