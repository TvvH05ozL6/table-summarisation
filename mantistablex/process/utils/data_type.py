...
class DataTypeEnum(Enum):
    ...
    def get_datatype_info(data_type):
        ...
        xml_string = "xsd:string"
        xml_float = "xsd:float"
        xml_integer = "xsd:integer"
        xml_double = "xsd:double"
        xml_date = "xsd:date"
        xml_boolean = "xsd:boolean"
        xml_any_uri = "xsd:anyURI"
        xml_coordinates = "georss:point"

        datatype_map = {
            DataTypeEnum.GEOCOORD: xml_coordinates, #xml_string,
            DataTypeEnum.ADDRESS: xml_string,
            DataTypeEnum.HEXCOLOR: xml_string,
            DataTypeEnum.URL: xml_any_uri,
            DataTypeEnum.NUMERIC: xml_integer,
            #    [
            #    xml_float,
            #    xml_integer,
            #    xml_double,
